//Please don't try to modify all of the following code, then you will know what is a disaster
...
$(function(){
	...
	if(userPanel){
		...
		ready : function(){
			...
			if(loginLayer){
				...
				var btnSpan=document.querySelectorAll(".inputAgin>span")[1];
				if(btnSpan){
	...
	*/
	...
	function showBtn(){
		...
		$(".inputAgin")[0].innerHTML="<span>补全信息</span>";
		$(".inputAgin span")[0].onclick=function(){
