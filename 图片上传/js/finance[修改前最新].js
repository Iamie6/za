	    ...
	    var s = '<div class="float_left border_css education margin_top_9 mouse_over_border"><span class="education_span margin_top_20">'+
				   ...
				   /*
				      '<table width="361" border="0" cellpadding="0" cellspacing="0">'+
                                   '<tr>'+
                                       '<td>'+
                                          '<select id="word_start_time_y" class="border_css float_left border_radius_5">'+
                                              '<option>2014</option>'+
                                              '<option>2015</option>'+
                                              '<option>2016</option>'+
                                           '</select>'+
                                       '</td>'+
                                       '<td>'+
                                            '<select id="word_start_time_m" class="border_css float_left border_radius_5 margin_left_6">'+
                                              '<option>02</option>'+
                                              '<option>03</option>'+
                                              '<option>04</option>'+
                                           '</select>'+
                                       ...
                                       '</td>'+
                                       '<td>'+
                                           '<select id="word_end_time_y" class="border_css float_left border_radius_5">'+
                                              '<option>2014</option>'+
                                              '<option>2015</option>'+
                                              '<option>2016</option>'+
                                           '</select>'+
                                       '</td>'+
                                       '<td>'+
                                           '<select id="word_end_time_m" class="border_css float_left border_radius_5 margin_left_6">'+
                                              '<option>02</option>'+
                                              '<option>03</option>'+
                                              '<option>04</option>'+
                                           '</select>'+
...
function createEducationSelect(object){
	    //就读开始时间 年
	    var ddl12 = DropDownList.create({
			select : $(object).find("#education_start_y"),
			attrs : {
				column : 5,     
				width  : 54,
				height: 36   
	    ...
	    var ddl13 = DropDownList.create({
			select : $(object).find("#education_start_m"),
			attrs : {
				column : 5,     
				width  : 30,
				height: 36    
		...
		//就读结束时间 年
	    var ddl14 = DropDownList.create({
			select : $(object).find("#education_end_y"),
			attrs : {
				column : 5,     
				width  : 54,
				height: 36
		...
		//就读结束时间 月
	    var ddl15 = DropDownList.create({
			select : $(object).find("#education_end_m"),
			attrs : {
				column : 5,     
				width  : 30,
				height: 36    
		...
		var ddl16 = DropDownList.create({
			container : $(object).find('.degree'),    // 指定下拉框的容器，不设定时为document.body
			attrs : {
				id : 'degree_select' + (num++),            // 指定一个id，必选
				column : 5,     // 只显示5行，超过以后显示滚动条
...
function createWorkSelect(object){
		//工作开始时间 年
		var ddl17 = DropDownList.create({
			select : $('#word_start_time_y'),    // 指定下拉框的容器，不设定时为document.body
			attrs : {
				column : 5,     // 只显示5行，超过以后显示滚动条
                width  : 54,    // 指定下拉框宽度为150px
...
$(".work_add_btn").click(function(){
	  var s = '<div class="work float_left border_css mouse_over_border work_01 margin_top_9">'+
                       '<span class="education_span margin_top_20">'+
                           '<span class="education_span_cell_left float_left">公司名称&nbsp;&nbsp;</span>'+
                           '<span class="education_span_cell_center border_css float_left border_radius_5">'+
                               '<input type="text" class="border_radius_5"/>'+
                           '</span>'+
                       '</span>'+
                       '<span class="education_span margin_top_20">'+
                           '<span class="education_span_cell_left float_left">职位名称&nbsp;&nbsp;</span>'+
                           '<span class="education_span_cell_center border_css float_left border_radius_5">'+
                               '<input type="text" class="border_radius_5"/>'+
                           '</span>'+
                       '</span>'+
                       '<span class="education_span margin_top_20">'+
                           '<span class="education_span_cell_left float_left">工作地点&nbsp;&nbsp;</span>'+
                           '<span class="education_span_cell_center border_css float_left border_radius_5">'+
                               '<input type="text" class="border_radius_5"/>'+
                           '</span>'+
                       '</span>'+
                       '<span class="education_span margin_top_20">'+
                           '<span class="education_span_cell_left float_left">工作时间&nbsp;&nbsp;</span>'+
                           '<span class="attend_time">'+
                               '<table width="361" border="0" cellpadding="0" cellspacing="0">'+
                                   '<tr>'+
                                       '<td>'+
                           ...
                           '</span>'+
                       '</span>'+
                       '<span class="responsibilities_span margin_top_20">'+
                           '<span class="responsibilities_cell_left float_left">工作职责&nbsp;&nbsp;</span>'+
                           '<textarea type="text" class="responsibilities border_css border_radius_5 float_left"></textarea>'+
                       '</span>'+
                       '<span class="pro_name_tips tips text_align_right cursor_p work_del_tips">点击此处删除&nbsp;&nbsp;</span>'+
                   '</div>';
